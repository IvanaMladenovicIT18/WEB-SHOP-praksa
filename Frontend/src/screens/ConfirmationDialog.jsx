                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Potvrda porudžbine</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={onClose}></button>
                        </div>
                        <div className="modal-body">
                            Da li ste sigurni da želite da kreirate porudžbinu?
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={onClose}>Zatvori</button>
                            <button type="button" className="btn btn-primary" onClick={onSave}>Sačuvaj promene</button>
                        </div>
                    </div>
                </div>
            </div>
